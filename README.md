AI Curl Counter mainly uses Mediapipe and OpenCV to track the number of reps the user did while doing arm curls, along with a customizable encouragement message. 
